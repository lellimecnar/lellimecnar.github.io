...
On a separate page, I have taken all the information I could find (from the CRLs, forums, wikis, etc.), and put it together into a single, unified, and coherent reference guide that I will try to keep it up to date as I learn more:

* [Uniform Reference Guide]({% link _costuming/imperial-officer/reference.md %})
